        ...
        messages = [
            {
                ...
                "content": [
                    ...
                    # Prompt for franka {"type": "text", "text": f"Locate the {instruction}. Return only the JSON: {{\"target\": {{\"bbox_xyxy\": [ymin, xmin, ymax, xmax]}}}} using normalized coordinates 0-1000."}
                    {
                        "type": "text",
                        "text": "Find all flat colored platforms on the floor in this image. "
                        "Return a JSON list of all platforms found: "
                        '{"platforms": [[ymin,xmin,ymax,xmax], [ymin,xmin,ymax,xmax], ...]} '
