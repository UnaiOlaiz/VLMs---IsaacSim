...
\addvspace {10\p@ }
\addvspace {10\p@ }
\contentsline {lstlisting}{\numberline {4.1}{\ignorespaces Scene graph caption result for the patient bed in the hospital scene.}}{47}{lstlisting.146}%
\contentsline {lstlisting}{\numberline {4.2}{\ignorespaces Structure template Qwen receives, consisting of the screenshot of the desired part of the environment and prompt. Similar to a JSON format.}}{49}{lstlisting.161}%
\contentsline {lstlisting}{\numberline {4.3}{\ignorespaces Custom prompt the VLM receives, indicating what to detect, what to return and the format of the returned data}}{49}{lstlisting.168}%
\contentsline {lstlisting}{\numberline {4.4}{\ignorespaces Command to start the created VLM service}}{50}{lstlisting.178}%
\contentsline {lstlisting}{\numberline {4.5}{\ignorespaces Multi-agent orchestration for blue cube}}{67}{lstlisting.231}%
