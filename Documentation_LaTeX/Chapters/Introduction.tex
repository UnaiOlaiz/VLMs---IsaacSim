...
\begin{itemize}
	\item Design progressively more complex environments in the robotic scenario simulator.
	
	\item Implement a communication system between VLM and the agents. 
	
	\item Define metrics to measure the success rate of cooperative tasks, the response time to natural language commands, and the model's ability to generalize across different environmental variations.
	
	\item Evaluate the robustness of the learned policies and the VLM's perception under different levels of domain randomization to assess the feasibility of future deployment on physical hardware.
\end{itemize}
...
\begin{itemize}
	...
	\item Communication pipeline orchestration.
\end{itemize}
