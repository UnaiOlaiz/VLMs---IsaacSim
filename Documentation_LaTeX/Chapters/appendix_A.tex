This first appendix lists the different source code and hyperparameter configurations used throughout the development process, and contents which have been referenced in the documentation but were put here due to their length or technical detail, in order to maintain the best readability flow as possible. 
